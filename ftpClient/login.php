...
<div class="alert alert-success">
    <bold>NOTICE - For a more easy to use FTP program to upload and edit your server files we reccomend using FileZilla.<br>
    <a href="https://filezilla-project.org/download.php?type=client">CLICK HERE</a> to download.</bold>
</div>
